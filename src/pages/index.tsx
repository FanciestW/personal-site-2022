  ...
  return (
    <div className="select-none">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-center flex-nowrap gap-12 min-h-fit w-9/12 max-w-screen-lg items-center mix-blend-difference text-blended-text py-10 sm:py-0">
